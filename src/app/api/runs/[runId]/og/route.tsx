...
// Node.js runtime required for Prisma (libsql adapter is not edge-compatible)
...
export async function GET(
  ...
  const distanceKm = (run.totalDistanceM / 1000).toFixed(2);
  const pace = formatPace(run.avgPaceSPerKm);
  const duration = formatDuration(run.totalDurationS);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{ fontSize: 22, fontWeight: 900, color: "#000000" }}
              >
                R
              </span>
            </div>
